...
Telegram: https://t.me/CROkemon

| 20% PURE USDC REWARDS | NO BULLSHIT | CONTRACT RENOUNCED | 100% COMMUNITY DRIVEN |
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IDEXRouter router;
    address routerAddress = 0x145677FC4d9b8F19B5D56d1820c48e0443049a30; //CroMeerkat router
...
contract CROkemon is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "CROkemon";
    string constant _symbol = "CMON";
